    ...
    <div className="coinSlider">
      <div className="w-full">
        <Carousel opts={{ align: "start" }} className="w-full">
          <CarouselContent className="pb-[0.2rem]">
            {skeletonLoader ? (
              <>
                <CoinSliderSkeleton />
                <CoinSliderSkeleton />
                    ...
                    >
                      <div className="pl-2 ml-2">
                        <Button
                          ...
                          value={coin.id}
                          className={`w-full h-full p-0 light:bg-white disabled:opacity-100 rounded-sm ${
                            graphDataError !== ""
                              ? "disabled:opacity-40"
                        ...
                        >
                          ...
                          >
                            <CardContent className="flex items-center gap-2 sm:gap-4 px-3 sm:px-4">
                              <div className="w-[1.5rem] h-[1.5rem] sm:w-[2.2rem] sm:h-[2.2rem] rounded-full  group-hover:scale-110 group-[&.active]/scaleImage:scale-110 transition-all ease-in-out duration-200 bg-white p-[.08rem] sm:p-0.5 ">
                                <Image
                                  width={100}
                                  height={100}
