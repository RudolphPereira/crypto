...
export const CoinSlider = () => {
  return (
    <div className="coinSlider">
      <div className="coinSliderBox w-full">
        <Carousel opts={{ align: "start" }} className="w-full">
          <CarouselContent className="">
                ...
                <Button className="w-full h-full p-0">
                  <Card className="rounded-sm py-4 w-full bg-black-russian border border-transparent border-b-0 text-white cursor-pointer hover:bg-periwinkle-blue/60 transition-all duration-200 ease-in">
                    <CardContent className="flex items-center gap-4 px-4">
                      <div className="iconBox w-[2rem] h-[2rem]">
                        <Image
                          src={bitcoinIcon}
                          alt="coin icon"
                      ...
                      <div className="textBox flex flex-col items-start gap-1">
                        <div className="coinNameBox text-base font-[500]">
                          <p>Bitcoin (BTC)</p>
                        </div>
                        <div className="priceBox flex gap-3">
                          <div className="currencyBox flex gap-1 text-xs font-[400] opacity-70">
                            <p>27,445.55</p>
                            <p>USD</p>
                          </div>
                          <div className="percentageBox flex gap-1.5 text-xs font-[400] items-center">
                            <div className="iconBox w-[0.7rem] h-[0.7rem]">
                              <Image
                                src={decreaseIcon}
                                alt="increase icon"
                                className="w-full h-full"
            ...
            >
              <div className="pl-2 ml-2">
                <Button className="w-full h-full p-0">
                  <Card className="active [&.active]:bg-periwinkle-blue/60 [&.active]:border-periwinkle-blue rounded-sm py-4 w-full bg-black-russian border border-transparent border-b-0 text-white cursor-pointer hover:bg-periwinkle-blue/60 transition-all duration-200 ease-in">
                    <CardContent className="flex items-center gap-4 px-4">
                      <div className="iconBox w-[2rem] h-[2rem]">
                        <Image
                          src={bitcoinIcon}
